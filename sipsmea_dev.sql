...
--
-- Host: localhost:3306
-- Generation Time: Jun 02, 2024 at 12:37 PM
...
(106, 7, 3, 3, 26, '2024-05-31 08:03:41', '2024-05-31 08:03:47'),
(107, 8, 4, 4, 26, '2024-05-31 08:03:41', '2024-05-31 08:03:47'),
(108, 9, 3, 10, 26, '2024-05-31 08:03:41', '2024-05-31 08:03:47'),
(109, 10, 2, 11, 26, '2024-05-31 08:03:41', '2024-05-31 08:03:47'),
(110, 8, 2, 12, 26, '2024-05-31 08:03:41', '2024-05-31 08:03:47'),
(111, 7, 4, 3, 39, '2024-05-31 08:04:27', '2024-05-31 08:04:34'),
(112, 8, 3, 8, 39, '2024-05-31 08:04:27', '2024-05-31 08:04:34'),
(113, 3, 3, 11, 39, '2024-05-31 08:04:27', '2024-05-31 08:04:34'),
(114, 4, 3, 12, 39, '2024-05-31 08:04:27', '2024-05-31 08:04:34'),
(115, 4, 3, 13, 39, '2024-05-31 08:04:27', '2024-05-31 08:04:34');
...
(2, 4, 2, 1, '2024-05-26 09:56:52', '2024-06-02 05:22:49'),
(3, 4, 3, 1, '2024-05-26 09:59:35', '2024-06-02 05:22:49'),
(4, 4, 4, 1, '2024-05-26 10:00:49', '2024-06-02 05:22:49'),
(5, 2, 5, 1, '2024-05-26 10:02:32', '2024-06-02 05:22:49'),
(6, 6, 6, 1, '2024-05-26 10:11:13', '2024-06-02 05:22:49'),
(7, 3, 7, 1, '2024-05-26 10:12:23', '2024-05-31 14:16:53'),
(8, 3, 8, 1, '2024-05-26 10:14:47', '2024-05-31 08:04:27'),
(9, 2, 9, 1, '2024-05-26 10:15:37', '2024-05-30 14:10:20'),
(10, 3, 10, 1, '2024-05-26 10:16:45', '2024-05-31 08:03:41'),
(11, 3, 11, 1, '2024-05-26 10:17:29', '2024-05-31 14:16:53'),
(12, 3, 12, 1, '2024-05-26 10:18:43', '2024-05-31 08:04:27'),
(13, 3, 13, 1, '2024-05-26 10:19:40', '2024-05-31 08:04:27');
...
(7, 'YUHLEZ Software House', 'Jl. Griya Tiara Asri II No.02, Desa Kalisapu, Kec. Slawi, Kabupten Tegal, Jawa Tengah 52416', '0821-2512-6584', 'Buka 24 Jam', 'https://maps.app.goo.gl/pdwsf2fS1iQzecC8A', 'https://lh5.googleusercontent.com/p/AF1QipNwBcfIjLIXYRyWN6BZN6IH0n7c5P02vwDz_Itv=s473-k-no', 4, 4, 4, 'aktif', '2024-05-26 10:12:23', '2024-05-31 16:39:58'),
...
(11, 'Dinas Perindustrian dan Tenaga Kerja', 'Jl. DR. Soetomo No.12,  Kecamatan Slawi, Kabupaten Tegal, Jawa Tengah 52417', '(0283) 491784', '7.15-16.15', 'https://maps.app.goo.gl/nF9V4VQKsbHbBBkk8', 'https://lh5.googleusercontent.com/p/AF1QipOCsrq1l8Ffu-A9S2ZJ6Kp2iUSeuu6BVTsRtfEc=w408-h306-k-no', 4, 4, 3, 'aktif', '2024-05-26 10:17:29', '2024-05-31 16:41:53'),
...
CREATE TABLE `users` (
  ...
  `verifikasi_siswa` enum('terima','tolak') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'tolak',
  `status` enum('aktif','nonaktif') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'aktif',
...
INSERT INTO `users` (`id`, `name`, `nisn`, `email`, `email_verified_at`, `password`, `pwd_nohash`, `google_id`, `facebook_id`, `verifikasi_siswa`, `status`, `role`, `w1`, `w2`, `w3`, `w4`, `w5`, `created_at`, `updated_at`) VALUES
(1, 'admin', '11111', 'admin@sipsmea.my.id', '2024-05-26 09:30:53', '$2y$12$C4kOn0JLuh6ktvEKcQQZP.H7Q9EE/j95k/JVIZVUAXQ2HMYFD8LmW', '12345qwert', NULL, NULL, 'terima', 'aktif', 'admin', 0, 0, 0, 0, 0, NULL, '2024-05-28 01:29:44'),
(2, 'Akun Demo', '12345', 'demo1@sipsmea.my.id', '2024-05-26 09:30:53', '$2y$12$o1VgxQVQgYObaKZQ8i3VEO6732.rmwjbQDZXM4UlVp258CI6OOuTS', 'hgu7lr9zSa211K0zzk', NULL, NULL, 'terima', 'aktif', 'siswa', -4, 3, 5, 5, -3, NULL, '2024-05-26 12:05:37'),
(11, 'Akun Demo 2', '16672', 'demo2@sipsmea.my.id', '2024-05-26 14:49:27', '$2y$12$QHS2kRDaVG8HpVmaTnPzXuSPimmlfidy6o9UhE2vVoPmxFSe1DK3e', '246wryi123', NULL, NULL, 'terima', 'aktif', 'siswa', 0, 0, 0, 0, 0, '2024-05-26 14:48:54', '2024-06-02 05:22:49'),
(21, 'Budi Hartono', '17422', 'budhar88@gmail.com', '2024-05-27 08:20:30', '$2y$12$ORbXHAeabuR7SXKzs.W9wO0j43DT9hJbkzTB4PwdZ2FzcsL7/j.Ci', 'xQeKQ1z6AO8714gq894', NULL, NULL, 'terima', 'aktif', 'siswa', -4, 2, 2, 5, -3, '2024-05-27 08:20:30', '2024-05-27 09:44:03'),
(22, 'Putri Riansyah', '17721', 'putriansyah62@gmail.com', '2024-05-27 09:18:50', '$2y$12$zsyukM4QXBbQbSGgrQdWrOZi84kBE.qa1kKckvWW4iC2SSGglYT86', 'F34onmvde1478DHk564', NULL, NULL, 'terima', 'aktif', 'siswa', -3, 4, 4, 3, -4, '2024-05-27 09:18:50', '2024-05-27 09:44:51'),
(23, 'Danu Vinanda', '17521', 'danuvinand22@gmail.com', '2024-05-27 09:19:37', '$2y$12$fwKsyeQKaGO7IPAtpnb2o.4hjGtLVNWwuhdYDrotjjoCYX3nkmIjm', '8Gdd2DwNuU10890h806', NULL, NULL, 'terima', 'aktif', 'siswa', -3, 5, 4, 2, -4, '2024-05-27 09:19:37', '2024-05-27 09:45:43'),
(24, 'Galih Pratama', '17782', 'galihpratama540@gmail.com', '2024-05-27 09:41:16', '$2y$12$DyOZnVt6uB2WZtV3csj70.ZzcfJbpUYQW0ILjx2.Ic3sdXnVb7isa', 'VDTQ9IOViY772frR594', NULL, NULL, 'terima', 'aktif', 'siswa', -5, 3, 5, 5, -3, '2024-05-27 09:41:16', '2024-05-27 09:46:38'),
(25, 'Muhammad Dani', '17791', 'mhmmaddarusman@gmail.com', '2024-05-27 09:48:47', '$2y$12$rMqZyMc4.dHyrrYRDyh7G.p75cKIMyau41/QzvbeT7gaBQScp0uMu', 'xsitLQhyPo546Zqq166', NULL, NULL, 'terima', 'aktif', 'siswa', -3, 5, 5, 3, -5, '2024-05-27 09:48:47', '2024-05-30 11:40:37'),
(26, 'Laely Fadhillah', '17711', 'laelyfadhillah222@gmail.com', '2024-05-27 09:49:21', '$2y$12$UqTHjE1LmyBEeDLZ37vVqO1/ccsu3squ1qdgiZ2gYfTlov0BHoTcG', '9MAUwev6A7684bW9823', NULL, NULL, 'terima', 'aktif', 'siswa', -3, 5, 3, 4, -2, '2024-05-27 09:49:21', '2024-05-31 08:03:56'),
(36, 'Karin Salsabila', '17715', 'salsabillaa21@gmail.com', '2024-05-31 06:13:42', '$2y$12$26WziDVmib.2FnGyxGUwMOv1PD.HARbKBcwuG3g9mEMF0nPF9i8o2', '04UgBjExGL986SLt499', NULL, NULL, 'tolak', 'aktif', 'siswa', 0, 0, 0, 0, 0, '2024-05-31 06:13:42', '2024-05-31 06:13:54'),
(37, 'Putri Rahmawati', '17717', 'putrahmawatti54@gmail.com', '2024-05-31 06:14:30', '$2y$12$eyS97WRCcnGylODiNpu2j.7ptiyByg/WCqQMTLYK4rPtgCHnh8CPS', 'NqwwztyCoD603nkS856', NULL, NULL, 'tolak', 'aktif', 'siswa', 0, 0, 0, 0, 0, '2024-05-31 06:14:30', '2024-05-31 06:14:30'),
(38, 'Muhammad Iqbal', '17720', 'muhiqball102@gmail.com', '2024-05-31 06:18:16', '$2y$12$J2y7AgIEN41Fd.MOTvDJP.SDiczS/YLdt9tBIfONHIWc4KzvD3yeC', 'wq40shSXbJ498SOt532', NULL, NULL, 'tolak', 'aktif', 'siswa', 0, 0, 0, 0, 0, '2024-05-31 06:18:16', '2024-05-31 06:18:16'),
(39, 'Dyah Puspita', '17724', 'dyahpusp122@gmail.com', '2024-05-31 06:21:07', '$2y$12$/xedZEkbaSxVsjloAht8KeQKYMHXUu94Lgynql7RJQSCaguYdlT9u', 'D5wtfB76FK218JbD785', NULL, NULL, 'terima', 'aktif', 'siswa', -4, 2, 2, 5, -4, '2024-05-31 06:21:07', '2024-05-31 08:04:42'),
(40, 'Satria Budiman', '17728', 'satttr0111@gmail.com', '2024-05-31 06:35:58', '$2y$12$psnt01/w68zNhdp5oALfieFeDpILYquKx1nl93yiNdy1oGO98dEN6', 'vTgHLi2z0Z668mL0971', NULL, NULL, 'terima', 'aktif', 'siswa', 0, 0, 0, 0, 0, '2024-05-31 06:35:58', '2024-05-31 06:35:58');
