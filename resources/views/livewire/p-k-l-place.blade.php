                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ $value->image_url }}" target="_blank">
                                    <img src="{{ $value->image_url }}" width="90" height="70"
                                        alt="image-place"></a>
                            </td>
                        ...
                        <form>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    @if ($errors->has('title'))
                                        <div class="error_message mt-1" style="font-size: 0.75rem; color: red;">
                                            <i
                                                class="fas fa-exclamation-circle mr-1"></i>{{ $errors->first('title') }}
                                        </div>
                                    @endif
                                </div>
                                <div class="form-group col-12">
                                    <label for="location">Lokasi</label>
                                    <input placeholder="lokasi..." type="text" class="form-control"
                                        id="location" wire:model="location">
                                    @if ($errors->has('location'))
                                        <div class="error_message mt-1" style="font-size: 0.75rem; color: red;">
                                            <i
                                                class="fas fa-exclamation-circle mr-1"></i>{{ $errors->first('location') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input placeholder="7.15-16.15" type="text" class="form-control"
                                        id="open_time" wire:model="open_time">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    @if ($errors->has('rating'))
                                        <div class="error_message mt-1" style="font-size: 0.75rem; color: red;">
                                            <i
                                                class="fas fa-exclamation-circle mr-1"></i>{{ $errors->first('rating') }}
                                        </div>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
